...
project = u'Garbage_Classification'
...
htmlhelp_basename = 'Garbage_Classificationdoc'
...
latex_documents = [
    ('index',
     'Garbage_Classification.tex',
     u'Garbage_Classification Documentation',
     u"Chrysostomos Papadopoulos, Konstantinos Spyrikos", 'manual'),
]
...
man_pages = [
    ('index', 'Garbage_Classification', u'Garbage_Classification Documentation',
     [u"Chrysostomos Papadopoulos, Konstantinos Spyrikos"], 1)
]
